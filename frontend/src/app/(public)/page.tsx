...
const steps = [
  { n: 1, title: "Scan Your Bill", desc: "Just take a photo of your supplier bill with your phone camera.", icon: "photo_camera", color: "text-primary" },
  { n: 2, title: "AI Checks Prices", desc: "Our AI automatically finds the best rates from different wholesalers.", icon: "search_check", color: "text-primary" },
  { n: 3, title: "You Save Money", desc: "See exactly where you are overpaying and increase your daily profit.", icon: "payments", color: "text-emerald-500" },
];

const footerLinks = [
  { heading: "Product", links: ["Seller Portal", "AI Insights", "API Access", "Enterprise"] },
    ...
    <div className="font-outfit text-slate-900 dark:text-slate-100">
      ...
      <section className="relative pt-28 pb-16 px-6  overflow-hidden bg-[#f6f6f8] dark:bg-[#101622]">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">
            Scan your bills, track your suppliers, and see exactly where you can save money. No more manual calculations.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="flex-1 space-y-6">
              ...
              <h2 className="font-space-grotesk text-4xl font-bold tracking-tight">How it Works in 3 Simple Steps</h2>
                ...
                {steps.map(({ n, title, desc, icon, color }) => (
                  <div key={n} className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <span className={`material-symbols-outlined ${color} mt-2 block`}>{icon}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="flex-1 w-full space-y-4">
              <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-500">Price Hike Alert</p>
                  <p className="font-space-grotesk text-lg font-bold dark:text-slate-100">Milk price increased by ₹2</p>
                </div>
              </div>
              <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-500">Extra Profit Found</p>
                  <p className="text-lg font-bold text-emerald-600">Save ₹450 on Oil today</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#f6f6f8] dark:bg-[#101622]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-space-grotesk text-4xl font-bold tracking-tight mb-4">Track Price Trends Over Time</h2>
            <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg">
              See price history for every item and every supplier — predict spikes and negotiate better.
            </p>
          </div>
          <PriceChart />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
            <div className="flex-1 space-y-6">
              ...
              <h2 className="font-space-grotesk text-4xl font-bold tracking-tight">Compare Wholesale Rates</h2>
              <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                Instantly see who gives you the best deal. Switch suppliers with confidence and never overpay again.
              </p>
            </div>
                ...
                <table className="w-full text-left text-sm text-slate-700 dark:text-slate-200">
                  ...
                  <tbody>
                    <tr className="border-b border-slate-50 dark:border-slate-800/50">
                      ...
                      <td className="py-4 font-mono text-emerald-500">₹42/unit</td>
                      <td className="py-4"><span className="text-emerald-500 font-bold">Best Price</span></td>
                    </tr>
                    <tr className="border-b border-slate-50 dark:border-slate-800/50">
                      <td className="py-4">City Wholesalers</td>
                      <td className="py-4 font-mono text-amber-500">₹45/unit</td>
                      <td className="py-4"><span className="text-red-500 font-bold">Overpaying</span></td>
                    </tr>
                    <tr>
                      ...
                      <td className="py-4">
                        <div className="flex text-amber-400">
                          ...
                          <span className="material-symbols-outlined" style={{ fontSize: "16px" }}>star</span>
                          <span className="material-symbols-outlined" style={{ fontSize: "16px" }}>star_half</span>
                        </div>
                      </td>
                    </tr>
                  </tbody>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <h2 className="font-space-grotesk text-5xl font-bold leading-tight">Your Personal Profit Assistant</h2>
              <p className="text-slate-400 text-lg leading-relaxed">
                Our smart assistant looks at your bills and tells you exactly where you can save. It&apos;s like having a business manager in your pocket.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                  <h4 className="font-space-grotesk font-bold mb-2">Inventory Prediction</h4>
                  <p className="text-sm text-slate-400">Know what to stock before you run out, based on your purchase patterns.</p>
                </div>
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                  <h4 className="font-space-grotesk font-bold mb-2">Cost Optimization</h4>
                  <p className="text-sm text-slate-400">Automatically surface the cheapest option for every item you buy.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-primary/20 p-2 rounded-3xl border border-primary/30 backdrop-blur-sm">
              <div className="bg-slate-900 rounded-2xl p-8 space-y-6">
                <div className="flex items-center gap-4 border-b border-white/10 pb-6">
                  ...
                  <div>
                    <h4 className="font-space-grotesk font-bold">AI Assistant</h4>
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 p-4 rounded-xl rounded-tl-none mr-12 text-sm text-slate-300">
                    I found that City Wholesalers is charging you ₹3 more for Rice than the local Mandi. Want me to mark them as &apos;Expensive&apos;?
                  </div>
                  ...
                  <div className="bg-white/5 p-4 rounded-xl rounded-tl-none mr-12 text-sm text-slate-300 italic">
                    Done! I&apos;ll notify you when Oil prices drop. Currently tracking 3 suppliers for the best rate.
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-[#f6f6f8] dark:bg-[#101622] text-slate-900 dark:text-slate-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-space-grotesk text-4xl font-bold mb-6">Start Making More Profit Today</h2>
          <p className="text-slate-600 dark:text-slate-400 text-lg mb-10">
            Join hundreds of Kirana shop owners who are using Invoice IQ to grow their business.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
            <div className="col-span-2">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="font-space-grotesk text-lg font-bold tracking-tight">Invoice IQ</h2>
              </div>
              <p className="text-slate-500 text-sm max-w-xs leading-relaxed">
                The simplest way for Indian retail shops to track bills and grow profits. Made for Kirana store owners.
              </p>
            </div>
